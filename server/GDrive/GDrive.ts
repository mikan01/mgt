...
const CLIENT_ID = '699020587112-6nue2jqqdlggs8gl730ddpf7kkijenqs.apps.googleusercontent.com';
const CLIENT_SECRET = 'qqv9KY0hwpmOJ_-hhBinH_0H';
const REDIRECT_URL = 'https://miagain.herokuapp.com/oauthCallback';
const SCOPES = [
